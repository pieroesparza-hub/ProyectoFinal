...
def main(args):  # Write the function name for the main data preparation logic
    ...
    train_df.to_csv(os.path.join(args.train_data, "raw_data.csv"), index=False)  # Specify the name of the train data file
    test_df.to_csv(os.path.join(args.test_data, "raw_data.csv"), index=False)  # Specify the name of the test data file
